...
- A compact API response summarizing targeted contacts, executed screenings, contacts with and without OFAC / UK / UN matches, per-list match counts, screening-error contact ids, and any sanctions-availability warnings
