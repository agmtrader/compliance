...
1. The operator runs `source_of_wealth_analysis.py` from `agm-api` after loading `.env`.
...
- Entry surface: `agm-api/source_of_wealth_analysis.py`
- Extraction tests: `agm-api/tests/test_source_of_wealth_analysis.py`
